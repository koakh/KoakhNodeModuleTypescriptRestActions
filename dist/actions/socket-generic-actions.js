...
exports.SocketGenericActions = exports.MISSING_BODY = exports.MISSING_PARAMETERS = exports.NOT_IMPLEMENTED = void 0;
const typescript_simple_logger_1 = require("@koakh/typescript-simple-logger");
const app_1 = require("../../app");
const util_1 = require("../../util");
// tslint:disable-next-line: max-line-length
const types_1 = require("../types");
const c3_cloud_client_1 = require("./client-type/c3-cloud-client");
const cc_socket_client_1 = require("./client-type/cc-socket-client");
const base_1 = require("./service/base");
const syncthing_1 = require("./service/syncthing");
 ...
 */
class SocketGenericActions {
    constructor(socketClient, syncthingClient) {
        ...
        this.getGenericEventActionKey = (action) => {
            try {
                ...
                const eventAction = util_1.getEnumKeyFromEnumValue(types_1.GenericEventAction, action);
        ...
        this.initGenericEventActionMapAll(socketClient.clientType);
    }
    /**
    ...
    processAction(action, payload, callback) {
        try {
            ...
            app_1.App.log(typescript_simple_logger_1.LogLevel.ERROR, `${types_1.SocketEvent.CLIENT_CHANNEL} ${error}`);
            // always fire callback for server acknowledge
            callback(error.message, null);
        }
    }
    initGenericEventActionMapAll(socketClientType) {
        ...
        const actionsBase = new base_1.SocketGenericActionsBaseService(this.syncthingClient, this.socketClient, this.getGenericEventActionKey);
        this.genericEventActionMapArray.push(actionsBase.getActions());
        // common actions for all clients: push SocketGenericActionsSyncthingService service component
        const actionsSyncthing = new syncthing_1.SocketGenericActionsSyncthingService(this.syncthingClient);
        this.genericEventActionMapArray.push(actionsSyncthing.getActions());
        // add clientType actions
        switch (socketClientType) {
            case types_1.SocketClientType.C3_CLOUD_CLIENT:
                const actionsC3CloudClient = new c3_cloud_client_1.SocketGenericActionsC3CloudClient(this.syncthingClient);
                this.genericEventActionMapArray.push(actionsC3CloudClient.getActions());
                break;
            case types_1.SocketClientType.CC_SOCKET_CLIENT:
                // cloudControlSocketClient specific type actions: push actionsCcSocketClient service component
                const actionsCcSocketClient = new cc_socket_client_1.SocketGenericActionsCcSocketClient();
                this.genericEventActionMapArray.push(actionsCcSocketClient.getActions());
            default:
                break;
        }
...
exports.SocketGenericActions = SocketGenericActions;
//# sourceMappingURL=socket-generic-actions.js.map